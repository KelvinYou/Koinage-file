...
<body>
    ...
    <script>
        ...
        function showapikeys() {
            ...
            // xhttp.open("GET", "http://35.198.204:8051/api/v1/wallet/account?label=test@test.com", true);
            xhttp.open("GET", "http://35.198.204:8051/api/v1/wallet/account?label="+email, true);
            xhttp.send();
